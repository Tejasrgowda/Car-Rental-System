...
<h2>Car Name/Model: <span class="property_size"><?php echo $rws['car_name'];?></span>
</h2>
...
<td><input type="datetime" name="FROM_DT_TIME" required></td>
...
<td><input type="text" name="RET_DT_TIME" required></td>
...
$FROM_DT_TIME = $_POST['FROM_DT_TIME'];

$RET_DT_TIME = $_POST['RET_DT_TIME'];
						
							
$qry = "INSERT INTO client (fname,id_no,gender,email,phone,location,car_id,status,FROM_DT_TIME,RET_DT_TIME)
							
VALUES('$fname','$id_no','$gender','$email','$phone','$location','$_GET[id]','Pending','$FROM_DT_TIME','$RET_DT_TIME')";
