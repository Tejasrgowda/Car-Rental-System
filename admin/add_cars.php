...
$qr = "INSERT INTO cars (image,car_name,car_type,hire_cost,capacity,status,CAR_CATEGORY_NAME,car_id) 
													
VALUES ('$image','$car_name','$car_type','$hire_cost','$capacity','Available','$CAR_CATEGORY_NAME','$car_id')";
